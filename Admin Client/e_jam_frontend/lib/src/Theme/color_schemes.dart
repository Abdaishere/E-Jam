...
const lightColorScheme = ColorScheme(
  ...
  secondary: Color(0xFF874589),
  onSecondary: Color(0xFFFFFFFF),
  secondaryContainer: Color(0xFFFFD6FA),
  onSecondaryContainer: Color(0xFF37003C),
  tertiary: Color(0xFF5B53A7),
...
const darkColorScheme = ColorScheme(
  ...
  secondary: Color(0xFFFBACF8),
  onSecondary: Color(0xFF521457),
  secondaryContainer: Color(0xFF6C2D70),
  onSecondaryContainer: Color(0xFFFFD6FA),
  tertiary: Color(0xFFC6BFFF),
  onTertiary: Color(0xFF2D2276),
  tertiaryContainer: Color(0xFF433B8E),

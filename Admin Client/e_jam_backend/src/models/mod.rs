...
pub struct StreamEntry {
    ...
    ## Constraints
    * Must be given (min length is 1) (max length is 50)
    "]
    #[validate(length(min = 1, max = 50, message = "name must be given"))]
    #[serde(rename = "name")]
    name: String,
    ...
    ## Constraints
    * Must be given (min length is 1) (max length is 255)
    "]
    #[validate(length(min = 1, max = 255, message = "description must be given"))]
    ...
    * Must be greater than or equal to 0
    ...
    ## Constraints
    * Must be given (min length is 1) (max length is 3)
    ...
    * Must be boolean
    ...
    #[doc = r" ## Stream Status
    This is the status of the stream
    check the StreamStatus enum for more details
    "]
...
if there are no devices left, the stream status will be set to stopped"]
    // TODO: update the stream status according to the processes status of the devices of the stream
    fn sync_stream_status(&mut self) {
        ...
        if working_generators + working_verifiers == 0 {

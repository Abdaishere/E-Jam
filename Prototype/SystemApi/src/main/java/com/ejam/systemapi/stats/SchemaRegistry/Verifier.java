 ...
 */
package com.example.systemapi.stats.SchemaRegistry;
...
public class Verifier extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
     ...
     */
    public Verifier(CharSequence macAddress, CharSequence streamId, Long packetsCorrect, Long packetsErrors, Long packetsDropped, Long packetsOutOfOrder) {
    ...
    public void put(int field$, Object value$) {
        switch (field$) {
            case 0:
                macAddress = (CharSequence) value$;
                break;
            case 1:
                streamId = (CharSequence) value$;
                break;
            case 2:
                packetsCorrect = (Long) value$;
                break;
            case 3:
                packetsErrors = (Long) value$;
                break;
            case 4:
                packetsDropped = (Long) value$;
                break;
            case 5:
                packetsOutOfOrder = (Long) value$;
                break;
            default:
                throw new IndexOutOfBoundsException("Invalid index: " + field$);
        }
     ...
     */
    public void setMacAddress(CharSequence value) {
     ...
     */
    public CharSequence getStreamId() {
        return streamId;
    }
     ...
     * @param value the value to set.
     */
    public void setStreamId(CharSequence value) {
        this.streamId = value;
    }
     ...
     */
    public static Verifier.Builder newBuilder() {
        return new Verifier.Builder();
    }
     ...
     * @return A new Verifier RecordBuilder
     */
    public static Verifier.Builder newBuilder(Verifier.Builder other) {
        if (other == null) {
            return new Verifier.Builder();
        } else {
            return new Verifier.Builder(other);
        }
    }
     ...
     * @return A new Verifier RecordBuilder
     */
    public static Verifier.Builder newBuilder(Verifier other) {
        if (other == null) {
            return new Verifier.Builder();
        } else {
            return new Verifier.Builder(other);
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Verifier>
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(Verifier.Builder other) {
            super(other);
         ...
         * @param other The existing instance to copy.
         */
        private Builder(Verifier other) {
            super(SCHEMA$);
            if (isValidValue(fields()[0], other.macAddress)) {
                this.macAddress = data().deepCopy(fields()[0].schema(), other.macAddress);
         ...
         * @return This builder.
         */
        public Verifier.Builder setMacAddress(CharSequence value) {
         ...
         * @return This builder.
         */
        public Verifier.Builder clearMacAddress() {
            macAddress = null;
         ...
         * @return This builder.
         */
        public Verifier.Builder setStreamId(CharSequence value) {
         ...
         * @return This builder.
         */
        public Verifier.Builder clearStreamId() {
            streamId = null;
         ...
         * @return This builder.
         */
        public Verifier.Builder setPacketsCorrect(long value) {
         ...
         * @return This builder.
         */
        public Verifier.Builder clearPacketsCorrect() {
         ...
         * @return This builder.
         */
        public Verifier.Builder setPacketsErrors(long value) {
         ...
         * @return This builder.
         */
        public Verifier.Builder clearPacketsErrors() {
         ...
         * @return This builder.
         */
        public Verifier.Builder setPacketsDropped(long value) {
         ...
         * @return This builder.
         */
        public Verifier.Builder clearPacketsDropped() {
         ...
         * @return This builder.
         */
        public Verifier.Builder setPacketsOutOfOrder(long value) {
         ...
         * @return This builder.
         */
        public Verifier.Builder clearPacketsOutOfOrder() {
        ...
        public Verifier build() {
            try {
                ...
                record.macAddress = fieldSetFlags()[0] ? this.macAddress : (CharSequence) defaultValue(fields()[0]);
                record.streamId = fieldSetFlags()[1] ? this.streamId : (CharSequence) defaultValue(fields()[1]);
                record.packetsCorrect = fieldSetFlags()[2] ? this.packetsCorrect : (Long) defaultValue(fields()[2]);
                record.packetsErrors = fieldSetFlags()[3] ? this.packetsErrors : (Long) defaultValue(fields()[3]);
                record.packetsDropped = fieldSetFlags()[4] ? this.packetsDropped : (Long) defaultValue(fields()[4]);
                record.packetsOutOfOrder = fieldSetFlags()[5] ? this.packetsOutOfOrder : (Long) defaultValue(fields()[5]);
                return record;

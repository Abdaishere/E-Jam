...
public class Generator extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    private static final long serialVersionUID = 7909036219500074881L;
    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse(
            "{\"type\":\"record\",\"name\":\"Generator\",\"namespace\":\"", "fields\":[{\"name\":\"macAddress\",\"type\":{\"type\":\"string\",\"pattern\":\"^([0-9A-Fa-f]{2}[:-]){5}([0-9A-Fa-f]{2})$\"}},{\"name\":\"streamId\",\"type\":{\"type\":\"string\",\"pattern\":\"^\\\\w{3}$\"}},{\"name\":\"packetsSent\",\"type\":{\"type\":\"long\",\"logicalType\":\"unsigned\"}},{\"name\":\"packetsErrors\",\"type\":{\"type\":\"long\",\"logicalType\":\"unsigned\"}}]}"
    );
     ...
     */
    public Generator(CharSequence macAddress, CharSequence streamId, Long packetsSent, Long packetsErrors) {
     ...
     * @return A new Generator RecordBuilder
     */
    public static Generator.Builder newBuilder(Generator.Builder other) {
        if (other == null) {
            return new Generator.Builder();
        } else {
            return new Generator.Builder(other);
        }
    }
     ...
     * @return A new Generator RecordBuilder
     */
    public static Generator.Builder newBuilder(Generator other) {
        if (other == null) {
            return new Generator.Builder();
        } else {
            return new Generator.Builder(other);
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Generator>
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(Generator.Builder other) {
            super(other);
         ...
         * @param other The existing instance to copy.
         */
        private Builder(Generator other) {
            super(SCHEMA$);
            if (isValidValue(fields()[0], other.macAddress)) {
                this.macAddress = data().deepCopy(fields()[0].schema(), other.macAddress);
         ...
         * @return This builder.
         */
        public Generator.Builder setMacAddress(CharSequence value) {
         ...
         * @return This builder.
         */
        public Generator.Builder clearMacAddress() {
            macAddress = null;
         ...
         * @return This builder.
         */
        public Generator.Builder setStreamId(CharSequence value) {
         ...
         * @return This builder.
         */
        public Generator.Builder clearStreamId() {
            streamId = null;
         ...
         * @return This builder.
         */
        public Generator.Builder setPacketsSent(long value) {
         ...
         * @return This builder.
         */
        public Generator.Builder clearPacketsSent() {
         ...
         * @return This builder.
         */
        public Generator.Builder setPacketsErrors(long value) {
         ...
         * @return This builder.
         */
        public Generator.Builder clearPacketsErrors() {
        ...
        public Generator build() {
            try {
                ...
                record.packetsSent = fieldSetFlags()[2] ? this.packetsSent : (Long) defaultValue(fields()[2]);
